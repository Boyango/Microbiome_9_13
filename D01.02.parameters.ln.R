...
cond.ziln.delta.pi20 <- cond.ziln.delta %>% filter (delta_pi > 1.8 & delta_pi < 2.2)
cond.ziln.delta.pi10$pi_id = 1.0
cond.ziln.delta.pi15$pi_id = 1.5
cond.ziln.delta.pi20$pi_id = 2.0

cond.ziln.delta.all = rbind(cond.ziln.delta.pi10, cond.ziln.delta.pi15, cond.ziln.delta.pi20)
